...
- "Have a clear concept of what good metadata entails."
...
-  The [CF (Climate and Forecast) metadata](https://http://cfconventions.org/) are designed to promote the processing and sharing of [NetCDF](https://en.wikipedia.org/wiki/NetCDF) files. The CF conventions are increasingly gaining acceptance and have been adopted by a number of projects and groups as a primary standard. The conventions define metadata that provide a definitive description of what the data in each variable represents, and the spatial and temporal properties of the data.
